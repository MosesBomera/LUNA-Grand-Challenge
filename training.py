...
class LunaTrainingApp:
    def __init__(self, sys_argv=None):
        ...
        parser.add_argument(
            "--tb-prefix",
            help="Data prefix for Tensorboard run.",
            default="tb"
        )
        parser.add_argument(
            "comment",
            help="Comment suffix for Tensorbaord run.",
            nargs="?",
            default="luna"
        )
    ...
    def initTrainDl(self):
        ...
        train_ds = LunaDataset(
            val_stride=10,
            isValSet_bool=False,
            ratio_int=int(self.cli_args.balanced), # Add balanced argument
        )
    ...
    def doTraining(self, epoch_ndx, train_dl):
        ...
        for batch_ndx, batch_tup in batch_iter:
            self.optimizer.zero_grad() # Prevent the gradient accumulation.
